...
public class ComputeEngineFormPage extends PricingCalculatorMainFrame {
    ...
    public ComputeEngineFormPage setNumberOfInstances(String number) {
        if (number != null) {
            scrollIntoView(waitUntilElementIsVisible(numberOfInstancesInput)).sendKeys(number);
        }
        return this;
    }
    ...
    public ComputeEngineFormPage addGPUs(String gpuType, String gpuCount) {
        if (gpuType != null && gpuCount != null) {
            scrollIntoView(waitUntilElementIsClickable(addGPUsCheckbox)).click();
    ...
    public ComputeEngineFormPage clickAddInstancesToEstimateButton() {
        scrollIntoView(waitUntilElementIsClickable(addInstancesToEstimateButton)).click();
        logger.info("Created new calculation");
        return this;
    }
